...
#Region " Form Display Methods - Code used to display this form." '============================================================================================================================
    ...
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        ...
        If FormNo > -1 Then
            Main.ClosedFormNo = FormNo 'The Main form property ClosedFormNo is set to this form number. This is used in the HtmlDisplayFormClosed method to select the correct form to set to nothing.
        End If
...
#Region " Form Methods - The main actions performed by this form." '===========================================================================================================================
    ...
    Private Sub frmHtmlDisplay_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        If FormNo > -1 Then
            Main.HTMLDisplayPageFormClosed()
        End If
    ...
    Private Sub btnSaveAs_Click(sender As Object, e As EventArgs) Handles btnSaveAs.Click
        ...
        'Dim NewFileName As String = Trim(txtFileName.Text)
